...
public class AoCDay7
{
    ...
    {
        if (CurrentFolderObject == null) { throw new Exception("Cannot Traverse Any Farther. Null Exception"); }
    ...
    public FileObject ParseCurrentLevel(FileObject CurrentFolder)
    {
        ...
        do
        {
            ...
            if (nextLine[0]=="dir")
            {
                ...
                FileObject newFolder = new FileObject(workingFolder, nextLine[1],newFolderContents);
